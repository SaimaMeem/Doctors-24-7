    ...
    <div class="container">
			...
			<div class="col-md-2">
				...
				<div class="col-md-4">
					...
					<div class="hoverbox" style="cursor: pointer;" onclick="window.location='http://localhost/finalupdate2/doctor_registration.php';">
						<div class="imagebox">
						<img style="height:100% !important;width:100% !important;"src="images\doc.jpg" alt="Avatar" class="image" style="width:100%">
						</div>
						<br>
						<div style="text-align:center;font-family: Comic Sans MS, cursive, sans-serif; font-style: italic;font-weight:bold;">
							<h4>I am a Doctor</h4>
				...
				<div class="col-md-4">
					<div class="hoverbox" style="cursor: pointer;" onclick="window.location='http://localhost/finalupdate2/patient_registration.php';">
						<div class="imagebox">
						<img style="height:100% !important;width:100% !important;"src="images\noticehover.jpg" alt="Avatar2" class="image" style="width:100%">
						</div>
						<br>
						<div style="text-align:center;font-family: Comic Sans MS, cursive, sans-serif; font-style: italic;font-weight:bold;">
